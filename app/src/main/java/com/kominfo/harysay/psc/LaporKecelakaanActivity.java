...
public class LaporKecelakaanActivity extends AppCompatActivity implements OnMapReadyCallback {

    GoogleMap map;
    EditText mlongitudekecelakaan,mlatitudekecelakaan;
    ...
    ImageView mLogoKameraKecelakaan;
    ImageView mFotoKecelakaan;

    Button mBtnLaporKecelakaan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mlongitudekecelakaan = (EditText) findViewById(R.id.longitudeKebakaran);
        mlatitudekecelakaan =(EditText) findViewById(R.id.latitudeKebakaran);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarlaporkecelakaan);
        ...
        mLogoKameraKecelakaan.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mFotoKecelakaan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                prepareStorage();
            }
        ...
        mBtnLaporKecelakaan=(Button)findViewById(R.id.btnLaporKebakaran);

        mBtnLaporKecelakaan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            }
        });
        ...
        if (map != null) {
            ...
            map.setOnMyLocationChangeListener(new GoogleMap.OnMyLocationChangeListener() {
                ...
                public void onMyLocationChange(Location arg0) {
                    ...
                    mlongitudekecelakaan.setText(Double.toString(arg0.getLongitude()));
                    mlatitudekecelakaan.setText(Double.toString(arg0.getLatitude()));
                }
            });
...
//        mlatitudekecelakaan.setText(Double.toString( map.getMyLocation().getLatitude()));
            ...
            case REQUEST_GET_SINGLE_FILE:
                if (resultCode == Activity.RESULT_OK && data != null){
                    ...
                    try{
                        ...
                        mFotoKecelakaan.setImageBitmap(bitmap);
    ...
    private void bindView() {
        ...
        mLogoKameraKecelakaan = findViewById(R.id.tambahfotokebakaran);
        mFotoKecelakaan=findViewById(R.id.fotoKebakaran);
